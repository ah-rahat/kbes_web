...
class IndexController extends Controller
{
    public function home()
    {
        ...
        $base64_enc = file_get_contents('https://kajbanglait.com/KajBanglaAccountDesk/api/get/getProcessedPassportInfo');
    ...
    public function passport_tracker_form(Request $request)
    {
        ...
        $error_msg=NULL;
        $showTab=1;
        $url='https://kajbanglait.com/KajBanglaAccountDesk/';
        $jsonData='{
    "queryData":{
   ...
   $base64=base64_encode($jsonData);
        $api_response = json_decode(file_get_contents('https://kajbanglait.com/KajBanglaAccountDesk/api/get/getPassportInfo?requestString='.$base64), true);
    ...
    else
    {
        ...
        return view('frontend/passport_tracker',compact('error_msg','error_code','api_response','showTab','url'));
    }
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://kajbanglait.com/KajBanglaAccountDesk/api/post/postComplain',
...
echo $response;
   ...
   "queryData":{
        ...
        $base64=base64_encode($jsonData);
        $api_response = json_decode(file_get_contents('https://kajbanglait.com/KajBanglaAccountDesk/api/get/getPassportVerificationInformation?requestString='.$base64), true);
         print $api_response;
    }
